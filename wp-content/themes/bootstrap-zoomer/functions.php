...
function add_css()
{
   wp_register_style('first', get_template_directory_uri() . '/css/main.css', false,'1.1','all');
...
function add_script()
{
   wp_register_script('js-script', get_template_directory_uri() . '/js/main.js', array ( 'jquery' ), 1.1, true);
   wp_enqueue_script( 'js-script');
}
add_action('wp_enqueue_scripts', 'add_script');//fonctionne pas